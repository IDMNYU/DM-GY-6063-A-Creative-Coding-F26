...
- Learn the basics of programming and creative coding using Javascript with the [p5.js](https://p5js.org/) library in the context of generative art and design
...
- Revise and develop a software experience as a final project.
...
Assignment submissions will be made through your github account.
...
There are no books required to purchase for class. Required reading material will be distributed weekly in class.
...
Your attendance is important and expected for all class meetings. Absences must be communicated ahead of time. Excessive absences will affect your final grade and can result in faliure of the course.

 Each unexcused absence will impact your final grade by a third of a letter (ex. one unexcused absence will drop a final grade of A- to B+, two unexcused absences would drop that A- to a B). If you have 2 or more unexcused absences, you fail the course automatically.
...
Notify the Office of Student Advocacy by [filling out this Google form](https://forms.gle/BA1mCpCAznE993Rv8) *in its entirety*.
...
Given that this is an introductory course to programming, there is no situation that warrants the use of these tools for generating code. Save that for a future when you might have to write tedious software for comparing large corpora of text. There should be a sense of play and exploration in the code you are writing, and a sense of accomplishment in learning how to make computers do things. This exploration doesn’t justify the use of tools that generate code.
...
If you are in violation of this policy more than once, you will fail the course. 
...
This syllabus and the course have been developed over the years by a number of people, including but not limited to: Thiago Hersan, Craig Fahner, Katherine Bennett, Tega Brain, Luke Dubois, and many, many others.
