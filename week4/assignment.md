...
- Print your sketch with a plotter. If you wish to set up your own computer to use the plotter, [refer to this guide](iDraw_Setup_Guide.html), otherwise use one of the iMacs in Room 325 to print your design. 
